...
def create_model(input_shape, config):
    ...
    #inception_model = Xception(include_top=False, weights=None, input_tensor=input_tensor)
    #keras.applications.xception.Xception(include_top=True, weights='imagenet', input_tensor=None, input_shape=None, pooling=None, classes=1000)
    #inception_model = inception_resnet_v2(include_top=False, weights=None, input_tensor=input_tensor)
